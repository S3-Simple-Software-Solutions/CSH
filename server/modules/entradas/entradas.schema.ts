...
export async function ensureEntradasSchema(): Promise<void> {
  ...
  // Reventa (mercado secundario). Vincula boletos a cuentas de aficionado,
  // guarda los listings, los saldos a pagar al vendedor (payout manual) y la
  // configuración de reventa. Espejo documental: migrations/008_entradas_reventa.sql
  await pool.query(`
    alter table entrada_ordenes
